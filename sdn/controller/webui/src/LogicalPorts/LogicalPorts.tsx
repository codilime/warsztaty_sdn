...
@observer
export class LogicalPorts extends React.Component<IProps, IState> {
  private store;
  ...
  private handleCreate = async () => {
    this.props.dialog
      .openDialog('createProject', '/logical_port', 'POST', {
  ...
  private handleRemove = (id: string) => {
    this.props.dialog
      .openDialog('removeProject', `/logical_port/${id}`, 'DELETE', {
...
export default translate('logicalPorts')(LogicalPorts);
